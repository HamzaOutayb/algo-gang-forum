...
func Routes(db *sql.DB) *http.ServeMux {
	...
	mux.Handle("/api/Signin", loginRateLimiter)
	...
	mux.HandleFunc("GET /api/chathistory", d.GethistoryHandler)
	...
	mux.HandleFunc("/api/GetComments/{postid}/", d.GetCommentsHandler)
